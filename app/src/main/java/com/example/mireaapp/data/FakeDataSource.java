package com.example.mireaapp.data;
...
public class FakeDataSource {
    ...
    public List<NewsItems> getFakeListNews() {


        List<NewsItems> data = new ArrayList<>();
        for(int index=0;index<30;index++) {

            NewsItems item = new NewsItems(index,
                    getRandomNewsTitle(),
                    getRandomUsername(),
                    getRandomNewsImage(),
                    getRandomUserImage(),
    ...
    public List<NewsItems> getFakeStaticListNews(){

        List<NewsItems> data = new ArrayList<>();
        data.add(new NewsItems(
                0,
                TXT_TITLE_01,
                TXT_NAME_01,
                IMG_NEWS_01,
    ...
    public List<NewsItems> getFakeUpdatedStaticListNews(){
        List<NewsItems> data = new ArrayList<>();
     ...
     */
    public NewsItems generateRandomNewsItem(){

        NewsItems item = new NewsItems(-1, getRandomNewsTitle(), getRandomUsername(), getRandomNewsImage(), getRandomUserImage(), getRandomContent(), getRandomBgColor(), null, 0);
        return item;
